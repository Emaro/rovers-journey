...
func apply_wheel_physics(car: RaycastCar) -> void:
	...
	if show_debug:
		DebugDraw3D.draw_arrow_ray(contact, y_force / car.mass, 1.0, Color.ORANGE, 0.1)
		DebugDraw3D.draw_arrow_ray(contact, x_force / car.mass, 1.0, Color.YELLOW, 0.1)
